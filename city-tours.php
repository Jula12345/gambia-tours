...
<head>
    ...
    <title>City Tours - Gambia Tours</title>
    ...
    <style>
        ...
        .tour-img { width: 100%; max-width: 400px; border-radius: 14px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); margin-bottom: 1em; }
...
<body>
    ...
    <div class="container">
        <h1>City Tours</h1>
        <img class="tour-img" src="https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=600&q=80" alt="Gambia City Tour">
        <p>Explore the heart of The Gambia with our city tours. Visit bustling markets, historic landmarks, and vibrant neighborhoods. Our expert guides will show you the best of Banjul, Serrekunda, and more.</p>
        <p>Enjoy authentic Gambian cuisine, meet local artisans, and immerse yourself in the rich culture and history of the region. Perfect for first-time visitors and seasoned travelers alike.</p>
    </div>
</body>
</html>